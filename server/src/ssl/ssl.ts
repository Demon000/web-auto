...
export function sslReadCertificate(certString: Buffer): any {
...
export function sslReadPrivateKey(privateKeyString: Buffer): any {
...
export function sslBioRead(bio: any, buf: Buffer, len: number): number {
    return BIO_read(bio, buf, len);
}

export function sslBioWrite(bio: any, buf: Buffer, len: number): number {
...
export function sslRead(ssl: any, buf: Buffer, len: number): number {
    return SSL_read(ssl, buf, len);
}

export function sslWrite(ssl: any, buf: Buffer, len: number): number {
